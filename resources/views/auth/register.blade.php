                    ...
                    <div class="wrap-login100 p-6">
                        <form class="login100-form validate-form" action="{{ url('register') }}" method="POST">
                            ...
                            <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                ...
                                <input class="input100 border-start-0 ms-0 form-control @error('name')
                                    is-invalid
                                @enderror" name="name" type="text" placeholder="Name">
                                @error('name')
                            ...
                            <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                ...
                                <input class="input100 border-start-0 ms-0 form-control @error('email')
                                    is-invalid
                            ...
                            <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                ...
                                <input class="input100 border-start-0 ms-0 form-control @error('password')
                            ...
                            <div class="text-center pt-3">
                                <p class="text-dark mb-0 d-inline-flex">Already have account ?<a href="{{ url('login') }}" class="text-primary ms-1">Sign In</a></p>
                            </div>
